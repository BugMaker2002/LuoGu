## [一、蒙德里安的梦想](https://www.acwing.com/problem/content/293/)
### 参考[思路](https://lishizheng.blog.csdn.net/article/details/112706309)
```cpp
/*
...
```
## [二、最短Hamilton路径](https://www.acwing.com/problem/content/93/)
### [题解](https://www.acwing.com/solution/content/18533/)
```cpp
#include<iostream>
#include<cstring>
#include<algorithm>
